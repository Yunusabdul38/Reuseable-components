...
export default function LeftNavigationBar() {
  ...
  return (
    ...
    >
      ...
      <div className="flex ">
          <ul
            className={`flex md:flex-row sm:absolute lg:relative sm:top-20 transition-all duration-300 lg:top-0 sm:left-0 py-4 lg:py-0 sm:bg-white lg:bg-inherit min-[500px]:px-12 text-nowrap min-[500px]:pt-8 min-[500px]:w-[30%] w-full md:w-full min-[500px]:h-screen h-fit md:h-fit lg:w-fit ${
              !menu ? "hidden h-0" : "flex-col min-[500px]:h-screen h-fit md:h-fit"
            } lg:flex md:flex-row md:justify-between md:items-center gap-3 md:gap-5 w-fit`}
          >
            <li>new arrival</li>
            <li>for men</li>
            <li>for women</li>
         ...
         <div className={`${menu?"min-[500px]:block":"min-[500px]:hidden"} hidden md:hidden bg-gray-800/50 top-20 h-screen absolute w-[70%] right-0`}  onClick={menuHandler} /> 
      </div>
